                       ...
                       <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                             <div class="clearfix">
                                  ...
                                  <strong class="pull-right"><sup>$</sup>{{ $cars->price }}.00</strong>
                             </div>
                        </li>
                    </ul>
                                ...
                                <li>
                                    ...
                                    <div class="accordion-content">
                                        <form action="{{ route('apply') }}" method="post">
                                            @csrf
                                            <input name="car_id" type="hidden" value="{{ $cars->id }}" class="form-control">

                                            <label>Pick Up Date:</label>
                                            <input name="pickup_date" type="date" class="form-control" placeholder="Needed For:">
                                            @error('pickup_date')
                                                {{ $message }}
                                            @enderror

                                            <label>Return Date:</label>
                                            <input name="end_date" type="date" class="form-control" placeholder="date of return">
                                            @error('end_date')
                                                {{ $message }}
                                            @enderror

                                            <button type="submit" class="bg-blue-500 w-50 hover:bg-blue-700 text-white font-bold py-5 px-5 rounded ml-16 mt-5">Rent It</button>
                                        </form>
                                    </div>
                                </li>
                                {{-- @endif --}}
