            ...
            <table class="responsive-table">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td id="" data-title="Pick Up">{{ $rent->pickup_date }}</td>
                    <td id="" data-title="Expected Return">{{ $rent->end_date }}</td>
                    <td data-title="Status" data-type="currency">{{ $rent->status }}</td>
                  ...
                  <tr>
                    <th scope="row">{{ $rent->cars->vehicle_type }}</th>
                    <td data-title="Pick Up">{{ $rent->pickup_date }}</td>
                    <td data-title="Expected Return">{{ $rent->end_date }}</td>
                    <td data-title="Status" data-type="currency">{{ $rent->status }}</td>
                    <td data-title="Actions" data-type="currency">
